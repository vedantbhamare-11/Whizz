    ...
    <div className="w-full max-w-3xl bg-white p-8 rounded-lg shadow-md">
      ...
      <div className="sm:hidden mt-6">
        ...
        <div className="cursor-pointer">
          ...
          <Input id="logoInput" type="file" className="hidden" accept="image/*" onChange={handleFileChange} />
        </div>
      </div>

      {/* Grid Layout for Form */}
      <form onSubmit={(e) => e.preventDefault()} className="lg:grid lg:grid-cols-2 md:grid md:grid-cols-2 gap-5 mt-6">
       {/* Left Column */}
<div className="space-y-4">
  <div className="grid gap-1.5">
    ...
    <Input
      ...
      onChange={(e) =>
        setFormValues({ ...formValues, restaurantName: e.target.value })
      }
    />
      ...
      <Input
        ...
        onChange={(e) => {
          ...
          if (/^-?\d*(\.\d*)?$/.test(value)) {
            ...
            setErrors((prevErrors) => ({ ...prevErrors, latitude: "" }));
          } else {
      ...
      <Input
        ...
        onChange={(e) => {
          ...
          if (/^-?\d*(\.\d*)?$/.test(value)) {
            ...
            setErrors((prevErrors) => ({ ...prevErrors, longitude: "" }));
          } else {
            setErrors((prevErrors) => ({
              ...prevErrors,
  ...
  <div className="grid grid-cols-2 gap-4">
    ...
    <div className="grid gap-1.5">
            ...
            <div className="grid grid-cols-3 gap-2">
              {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"].map((day) => (
                <div key={day} className="flex items-center space-x-2">
                  <Checkbox id={day.toLowerCase()} onCheckedChange={() => toggleDay(day)} />
      ...
      {/* Mobile Days Availability (Inside the Card, at the Bottom) */}
      ...
      <div className="flex justify-center mt-8">
        <Button type="submit" className="w-1/2 bg-[#3CAE06] hover:bg-[#36A205] text-white">
          Submit
        </Button>
      </div>
    </div>
