...
const completeProfile = async (req, res, next) => {
    ...
    console.log( vendorName, address, restaurantType, gst, area, vendorPhone, startTime, endTime, availableDays);
    
    if (!vendorName || !address || !restaurantType || !area || !vendorPhone || !startTime || !endTime || !availableDays) {
